...
3. **Finish**: `bd close <id> --reason "Done"`
4. **Sync**: `bd sync` (ALWAYS run this before `git push`)

## The Beads Workflow

Beads (bd) is a distributed issue tracker that lives in the repo.
It treats issue state exactly like code state.
